  ...
  async ngOnInit() {
    ...
    this.thicknessvalue="";
      ...
      this.search = this.formBuilder.group({
        ...
        diam: ['', [Validators.min(1500), Validators.max(9000)] ],
        tol1: ['0', [Validators.min(0), Validators.max(100)]],
        steel: [''],
        cycle: [''],
        thickness: [''],
        tol2: ['0', [Validators.min(0), Validators.max(100)]],
        degree: [''],
        steel_casting: [''],
        length: [''],
        tol3: ['0', [Validators.min(0), Validators.max(100)]],
        heat_treatment: [''],
        record: [''],
        actual_state: [''],
        pattern_code: [''],
