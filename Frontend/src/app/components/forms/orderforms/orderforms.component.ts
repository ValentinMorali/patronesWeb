...
//alert(this.listaaux[0].pattern_code)
  ...
  this.neworder = this.formBuilder.group({
    ...
    notify_auditor: ['', [Validators.required, Validators.nullValidator]],
    auditor: ['', [Validators.required, Validators.minLength(1) ]],
    ot: ['', [Validators.required, Validators.nullValidator]],
    acoustic_response: ['', Validators.required, Validators.nullValidator],

    virgin_tube: [{value: true, disabled: false}],
    diam: ['', Validators.required],
    degree: ['', Validators.required],
    cycle: ['', Validators.required],
    thickness: ['', Validators.required],
    steel: ['', Validators.required],
    steel_casting: ['', [Validators.required, Validators.min(20000), Validators.max(90000)]],
    length: ['0', [Validators.required, Validators.min(1500), Validators.max(9000)]],
    heat_treatment: ['', Validators.required],
    record: ['', Validators.required],
    num_trac_bme: ['0'],
    pattern_code: ['', Validators.required],
    existing_tube: [{value: false, disabled: false}],
...
//console.log(this.existing)
  ...
  this.neworder = this.formBuilder.group({
    ...
    notify_auditor: [this.neworder.get("notify_auditor").value, [Validators.required, Validators.nullValidator]],
    auditor: [this.neworder.get("auditor").value, [Validators.required, Validators.minLength(1) ]],
    ot: [this.neworder.get("ot").value, [Validators.required, Validators.nullValidator]],
    acoustic_response: [this.neworder.get("acoustic_response").value, [Validators.required, Validators.nullValidator]],
    ...
    thickness: ['', Validators.required],
    steel: ['', Validators.required],
    steel_casting: ['', Validators.required],
...
//this.dt =this.neworder.get("date").value;
  ...
  this.neworder = this.formBuilder.group({
    ...
    template: [this.neworder.get("template").value],
    client: [this.neworder.get("client").value, [Validators.required, Validators.minLength(4)]],
    notify_auditor: [n_a, [Validators.required, Validators.nullValidator]],
    auditor: [this.neworder.get("auditor").value, [Validators.required, Validators.minLength(1) ]],
    ot: [this.neworder.get("ot").value, [Validators.required, Validators.nullValidator]],
    acoustic_response: [a_r,  [Validators.required, Validators.nullValidator]],
