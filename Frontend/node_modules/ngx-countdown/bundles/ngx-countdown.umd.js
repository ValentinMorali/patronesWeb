(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-countdown', ['exports', '@angular/common', '@angular/core','@angular/core','@angular/common'], factory) :
    (factory((global['ngx-countdown'] = {}),global.ng.common,global.ng.core,global.ng.core,global.ng.common));
}(this, (function (exports,common,i0,ɵngcc0,ɵngcc1) { 
...
CountdownConfig.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: CountdownConfig, factory: function CountdownConfig_Factory(t) { return new (t || CountdownConfig)(); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CountdownConfig, [{
        type: i0.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return []; }, { demand: [], leftTime: [], template: [], effect: [], varRegular: [], clock: [] });
...
CountdownComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CountdownComponent, selectors: [["countdown"]], factory: function CountdownComponent_Factory(t) { return new (t || CountdownComponent)(ɵngcc0.ɵɵdirectiveInject(i0.ElementRef), ɵngcc0.ɵɵdirectiveInject(Timer), ɵngcc0.ɵɵdirectiveInject(CountdownConfig)); }, hostBindings: function CountdownComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CountdownComponent, [{
    ...
    }], function () { return [{ type: i0.ElementRef }, { type: Timer }, { type: CountdownConfig }]; }, { el: [], timer: [], cog: [], frequency: [], _notify: [], hands: [], left: [], paused: [], stoped: [], start: [{
            type: i0.Output
        }], finished: [{
            type: i0.Output
        }], notify: [{
...
CountdownModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: CountdownModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(CountdownModule, { declarations: [CountdownComponent], imports: [ɵngcc1.CommonModule], exports: [CountdownComponent] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CountdownModule, [{
        type: i0.NgModule,
        args: [{
...
CountdownModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function CountdownModule_Factory(t) { return new (t || CountdownModule)(); }, providers: [Timer], imports: [[common.CommonModule]] });
