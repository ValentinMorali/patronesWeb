...
export declare class CountdownComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CountdownComponent, "countdown", never, { 'config': "config" }, { 'start': "start", 'finished': "finished", 'notify': "notify", 'event': "event" }, never>;
}
