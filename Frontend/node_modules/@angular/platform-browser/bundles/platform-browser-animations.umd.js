...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('@angular/animations'), require('@angular/animations/browser'), require('@angular/common'),require('@angular/core'),require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@angular/platform-browser/animations', ['exports', '@angular/core', '@angular/platform-browser', '@angular/animations', '@angular/animations/browser', '@angular/common','@angular/core','@angular/platform-browser'], factory) :
...
}(this, function (exports, core, platformBrowser, animations, browser, common,ɵngcc0,ɵngcc1) { 'use strict';
...
BrowserAnimationBuilder.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: BrowserAnimationBuilder, factory: function BrowserAnimationBuilder_Factory(t) { return new (t || BrowserAnimationBuilder)(ɵngcc0.ɵɵinject(core.RendererFactory2), ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BrowserAnimationBuilder, [{
        type: Injectable
    }], function () { return [{ type: core.RendererFactory2 }, { type: Object, decorators: [{
                type: Inject,
...
AnimationRendererFactory.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AnimationRendererFactory, factory: function AnimationRendererFactory_Factory(t) { return new (t || AnimationRendererFactory)(ɵngcc0.ɵɵinject(core.RendererFactory2), ɵngcc0.ɵɵinject(browser.ɵAnimationEngine), ɵngcc0.ɵɵinject(core.NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AnimationRendererFactory, [{
        type: Injectable
    }], function () { return [{ type: core.RendererFactory2 }, { type: browser.ɵAnimationEngine }, { type: core.NgZone }]; }, { delegate: [], engine: [], _zone: [], _currentId: [], _microtaskId: [], _animationCallbacksBuffer: [], _rendererCache: [], _cdRecurDepth: [], promise: [], createRenderer: [], begin: [], _scheduleCountTask: [], scheduleListenerCallback: [], end: [], whenRenderingDone: [] });
...
InjectableAnimationEngine.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: InjectableAnimationEngine, factory: function InjectableAnimationEngine_Factory(t) { return new (t || InjectableAnimationEngine)(ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(browser.AnimationDriver), ɵngcc0.ɵɵinject(browser.ɵAnimationStyleNormalizer)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(InjectableAnimationEngine, [{
        type: Injectable
    }], function () { return [{ type: Object, decorators: [{
                type: Inject,
                args: [common.DOCUMENT]
            }] }, { type: browser.AnimationDriver }, { type: browser.ɵAnimationStyleNormalizer }]; }, null);
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(BrowserAnimationsModule, { exports: [ɵngcc1.BrowserModule] });
...
BrowserAnimationsModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function BrowserAnimationsModule_Factory(t) { return new (t || BrowserAnimationsModule)(); }, providers: BROWSER_ANIMATIONS_PROVIDERS, imports: [ɵngcc1.BrowserModule] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(NoopAnimationsModule, { exports: [ɵngcc1.BrowserModule] });
...
NoopAnimationsModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function NoopAnimationsModule_Factory(t) { return new (t || NoopAnimationsModule)(); }, providers: BROWSER_NOOP_ANIMATIONS_PROVIDERS, imports: [ɵngcc1.BrowserModule] });
