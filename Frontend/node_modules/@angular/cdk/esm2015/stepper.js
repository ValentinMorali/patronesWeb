...
CdkStepHeader.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkStepHeader, selectors: [["", "cdkStepHeader", ""]], factory: function CdkStepHeader_Factory(t) { return new (t || CdkStepHeader)(ɵngcc0.ɵɵdirectiveInject(ElementRef)); }, hostBindings: function CdkStepHeader_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkStepHeader, [{
    ...
    }], function () { return [{ type: ElementRef }]; }, { constructor: [], _elementRef: [], focus: [] });
/** @nocollapse */
...
CdkStep.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CdkStep, selectors: [["cdk-step"]], factory: function CdkStep_Factory(t) { return new (t || CdkStep)(ɵngcc0.ɵɵdirectiveInject(forwardRef(( /**
                     * @return {?}
                     */() => CdkStepper))), ɵngcc0.ɵɵdirectiveInject(STEPPER_GLOBAL_OPTIONS, 8)); }, contentQueries: function CdkStep_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkStep, [{
        ...
        args: [{ selector: 'cdk-step',
            ...
            }] }]; }, { constructor: [], _stepper: [], interacted: [], _editable: [], _optional: [], _completedOverride: [], _customError: [], _stepperOptions: [], _displayDefaultIndicatorType: [], _showError: [], editable: [{
            type: Input
        }], editable: [], optional: [{
            type: Input
        }], optional: [], completed: [{
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkStepper, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { constructor: [], _dir: [], _changeDetectorRef: [], _elementRef: [], _destroyed: [], _linear: [], _selectedIndex: [], selectionChange: [{
            type: Output
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkStepperNext, [{
    ...
    }], function () { return [{ type: CdkStepper }]; }, { constructor: [], _stepper: [], type: [{
            type: Input
        }], _handleClick: [{
            type: HostListener,
            args: ['click']
