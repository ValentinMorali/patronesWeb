...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTree, [{
    ...
    }], function () { return [{ type: IterableDiffers }, { type: ChangeDetectorRef }]; }, { _differs: [], _changeDetectorRef: [], _onDestroy: [], _levels: [], viewChange: [], dataSource: [{
            type: Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNode, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: CdkTree }]; }, { _elementRef: [], _tree: [], _destroyed: [], _dataChanges: [], role: [{
            type: Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkNestedTreeNode, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: CdkTree }, { type: IterableDiffers }]; }, { ngAfterContentInit: [], _dataDiffer: [], ngOnDestroy: [], updateChildrenNodes: [], _children: [], _clear: [], _getNodeOutlet: [], nodeOutlet: [{
            type: ContentChildren,
