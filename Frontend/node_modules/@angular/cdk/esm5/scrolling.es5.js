...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollDispatcher, [{
    ...
    }], function () { return [{ type: NgZone }, { type: Platform }]; }, { _ngZone: [], _platform: [], _scrolled: [], _globalSubscription: [], _scrolledCount: [], scrollContainers: [], register: [], deregister: [], scrolled: [], ngOnDestroy: [], ancestorScrolled: [], getAncestorScrollContainers: [], _scrollableContainsElement: [], _addGlobalListener: [], _removeGlobalListener: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkVirtualForOf, [{
        ...
        args: [{
                ...
                type: SkipSelf
            }] }, { type: NgZone }]; }, { _viewContainerRef: [], _template: [], _differs: [], _viewport: [], viewChange: [], _dataSourceChanges: [], cdkVirtualForTemplateCacheSize: [{
            type: Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ViewportRuler, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: Platform }, { type: NgZone }]; }, { _platform: [], ngOnDestroy: [], getViewportSize: [], _viewportSize: [], getViewportRect: [], getViewportScrollPosition: [], change: [], _updateViewportSize: [] });
