...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/collections'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/cdk/bidi'), require('@angular/cdk/coercion'), require('@angular/cdk/a11y'), require('@angular/common'),require('@angular/core'),require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('@angular/cdk/tree', ['exports', '@angular/cdk/collections', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/a11y', '@angular/common','@angular/core','@angular/common'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.tree = {}),global.ng.cdk.collections,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.cdk.bidi,global.ng.cdk.coercion,global.ng.cdk.a11y,global.ng.common,global.ng.core,global.ng.common));
}(this, (function (exports,collections,rxjs,operators,core,bidi,coercion,a11y,common,ɵngcc0,ɵngcc1) { 
const _c0 = ["role", "tree", 1, "cdk-tree"];
const _c1 = ["cdkTreeNodeOutlet", ""];
const _c2 = [1, "cdk-tree-node"];
const _c3 = [1, "cdk-tree-node", "cdk-nested-tree-node"];
'use strict';
...
CdkTreeNodeOutlet.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTreeNodeOutlet, selectors: [["", "cdkTreeNodeOutlet", ""]], factory: function CdkTreeNodeOutlet_Factory(t) { return new (t || CdkTreeNodeOutlet)(ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(CDK_TREE_NODE_OUTLET_NODE, 8)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNodeOutlet, [{
        type: core.Directive,
        args: [{
...
CdkTreeNodeDef.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTreeNodeDef, selectors: [["", "cdkTreeNodeDef", ""]], factory: function CdkTreeNodeDef_Factory(t) { return new (t || CdkTreeNodeDef)(ɵngcc0.ɵɵdirectiveInject(core.TemplateRef)); }, inputs: { when: ["cdkTreeNodeDefWhen", "when"] } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNodeDef, [{
        type: core.Directive,
        args: [{
...
CdkTree.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CdkTree, selectors: [["cdk-tree"]], factory: function CdkTree_Factory(t) { return new (t || CdkTree)(ɵngcc0.ɵɵdirectiveInject(core.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef)); }, contentQueries: function CdkTree_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, CdkTreeNodeDef, false, null);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadContentQuery()) && (ctx._nodeDefs = _t);
    } }, viewQuery: function CdkTree_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(CdkTreeNodeOutlet, true, null);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx._nodeOutlet = _t.first);
    } }, hostBindings: function CdkTree_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵelementHostAttrs(_c0);
    } }, inputs: { dataSource: "dataSource", treeControl: "treeControl", trackBy: "trackBy" }, exportAs: ["cdkTree"], consts: 1, vars: 0, template: function CdkTree_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementContainerStart(0, _c1);
        ɵngcc0.ɵɵelementContainerEnd();
    } }, directives: [CdkTreeNodeOutlet], encapsulation: 2 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTree, [{
        type: core.Component,
    ...
    }], function () { return [{ type: core.IterableDiffers }, { type: core.ChangeDetectorRef }]; }, { _differs: [], _changeDetectorRef: [], _onDestroy: [], _levels: [], viewChange: [], dataSource: [{
            type: core.Input
        }], dataSource: [], ngOnInit: [], _dataDiffer: [], ngOnDestroy: [], _dataSubscription: [], ngAfterContentChecked: [], _defaultNodeDef: [], _switchDataSource: [], _dataSource: [], _observeRenderChanges: [], renderNodeChanges: [], _getNodeDef: [], insertNode: [], treeControl: [{
            type: core.Input
        }], trackBy: [{
            type: core.Input
        }], _nodeOutlet: [{
...
CdkTreeNode.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTreeNode, selectors: [["cdk-tree-node"]], factory: function CdkTreeNode_Factory(t) { return new (t || CdkTreeNode)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(CdkTree)); }, hostBindings: function CdkTreeNode_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(3);
        ɵngcc0.ɵɵelementHostAttrs(_c2);
    } if (rf & 2) {
        ɵngcc0.ɵɵattribute("aria-expanded", ctx.isExpanded);
        ɵngcc0.ɵɵattribute("aria-level", ctx.role === "treeitem" ? ctx.level : null);
        ɵngcc0.ɵɵattribute("role", ctx.role);
    } }, inputs: { role: "role" }, exportAs: ["cdkTreeNode"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNode, [{
        type: core.Directive,
        args: [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: CdkTree }]; }, { _elementRef: [], _tree: [], _destroyed: [], _dataChanges: [], role: [{
            type: core.Input
        }], data: [], data: [], isExpanded: [], level: [], ngOnDestroy: [], focus: [], _setRoleFromData: [], _setRoleFromChildren: [] });
    return CdkTreeNode;
}());
...
CdkNestedTreeNode.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkNestedTreeNode, selectors: [["cdk-nested-tree-node"]], factory: function CdkNestedTreeNode_Factory(t) { return new (t || CdkNestedTreeNode)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(CdkTree), ɵngcc0.ɵɵdirectiveInject(core.IterableDiffers)); }, contentQueries: function CdkNestedTreeNode_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, CdkTreeNodeOutlet, true, null);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadContentQuery()) && (ctx.nodeOutlet = _t);
    } }, hostBindings: function CdkNestedTreeNode_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkNestedTreeNode, [{
        type: core.Directive,
        args: [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: CdkTree }, { type: core.IterableDiffers }]; }, { ngAfterContentInit: [], _dataDiffer: [], ngOnDestroy: [], updateChildrenNodes: [], _children: [], _clear: [], _getNodeOutlet: [], nodeOutlet: [{
            type: core.ContentChildren,
...
CdkTreeNodePadding.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTreeNodePadding, selectors: [["", "cdkTreeNodePadding", ""]], factory: function CdkTreeNodePadding_Factory(t) { return new (t || CdkTreeNodePadding)(ɵngcc0.ɵɵdirectiveInject(CdkTreeNode), ɵngcc0.ɵɵdirectiveInject(CdkTree), ɵngcc0.ɵɵdirectiveInject(core.Renderer2), ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8)); }, inputs: { level: ["cdkTreeNodePadding", "level"], indent: ["cdkTreeNodePaddingIndent", "indent"] } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNodePadding, [{
        type: core.Directive,
        args: [{
                selector: '[cdkTreeNodePadding]'
            }]
    }], function () { return [{ type: CdkTreeNode }, { type: CdkTree }, { type: core.Renderer2 }, { type: core.ElementRef }, { type: bidi.Directionality, decorators: [{
                type: core.Optional
            }] }]; }, { _treeNode: [], _tree: [], _renderer: [], _element: [], _dir: [], _destroyed: [], indentUnits: [], _indent: [], level: [{
            type: core.Input,
            args: ['cdkTreeNodePadding']
        }], level: [], indent: [{
            type: core.Input,
            args: ['cdkTreeNodePaddingIndent']
        }], indent: [], ngOnDestroy: [], _paddingIndent: [], _setPadding: [], _currentPadding: [] });
...
CdkTreeNodeToggle.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTreeNodeToggle, selectors: [["", "cdkTreeNodeToggle", ""]], factory: function CdkTreeNodeToggle_Factory(t) { return new (t || CdkTreeNodeToggle)(ɵngcc0.ɵɵdirectiveInject(CdkTree), ɵngcc0.ɵɵdirectiveInject(CdkTreeNode)); }, hostBindings: function CdkTreeNodeToggle_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNodeToggle, [{
        type: core.Directive,
        args: [{ selector: '[cdkTreeNodeToggle]' }]
    }], function () { return [{ type: CdkTree }, { type: CdkTreeNode }]; }, { _tree: [], _treeNode: [], _recursive: [], recursive: [{
            type: core.Input,
...
CdkTreeModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: CdkTreeModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(CdkTreeModule, { declarations: [CdkNestedTreeNode,
        CdkTreeNodeDef,
        CdkTreeNodePadding,
        CdkTreeNodeToggle,
        CdkTree,
        CdkTreeNode,
        CdkTreeNodeOutlet], imports: [ɵngcc1.CommonModule], exports: [CdkNestedTreeNode,
        CdkTreeNodeDef,
        CdkTreeNodePadding,
        CdkTreeNodeToggle,
        CdkTree,
        CdkTreeNode,
        CdkTreeNodeOutlet] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeModule, [{
        type: core.NgModule,
        args: [{
...
CdkTreeModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function CdkTreeModule_Factory(t) { return new (t || CdkTreeModule)(); }, providers: [a11y.FocusMonitor, CdkTreeNodeDef], imports: [[common.CommonModule]] });
