...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/coercion'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@angular/cdk/bidi'), require('@angular/cdk/collections'),require('@angular/core'),require('@angular/cdk/bidi'),require('@angular/cdk/platform')) :
	typeof define === 'function' && define.amd ? define('@angular/cdk/scrolling', ['exports', '@angular/core', '@angular/cdk/coercion', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@angular/cdk/bidi', '@angular/cdk/collections','@angular/core','@angular/cdk/bidi','@angular/cdk/platform'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.scrolling = {}),global.ng.core,global.ng.cdk.coercion,global.rxjs,global.rxjs.operators,global.ng.cdk.platform,global.ng.cdk.bidi,global.ng.cdk.collections,global.ng.core,global.ng.cdk/bidi,global.ng.cdk/platform));
}(this, (function (exports,core,coercion,rxjs,operators,platform,bidi,collections,ɵngcc0,ɵngcc1,ɵngcc2) { 
const _c0 = ["contentWrapper"];
const _c1 = [1, "cdk-virtual-scroll-viewport"];
const _c2 = ["cdk-virtual-scroll-orientation-horizontal", "cdk-virtual-scroll-orientation-vertical"];
const _c3 = [1, "cdk-virtual-scroll-content-wrapper"];
const _c4 = ["contentWrapper", ""];
const _c5 = [1, "cdk-virtual-scroll-spacer"];
const _c6 = ["width", "height"];
const _c7 = ["*"];
'use strict';
...
var CdkFixedSizeVirtualScroll = /** @class */ (function () {
    ...
    Object.defineProperty(CdkFixedSizeVirtualScroll.prototype, "itemSize", {
         ...
         * @return {?}
         */
        function (value) { this._itemSize = coercion.coerceNumberProperty(value); },
        enumerable: true,
        configurable: true
    });
...
CdkFixedSizeVirtualScroll.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkFixedSizeVirtualScroll, selectors: [["cdk-virtual-scroll-viewport", "itemSize", ""]], factory: function CdkFixedSizeVirtualScroll_Factory(t) { return new (t || CdkFixedSizeVirtualScroll)(); }, inputs: { itemSize: "itemSize", minBufferPx: "minBufferPx", maxBufferPx: "maxBufferPx" }, features: [ɵngcc0.ɵɵProvidersFeature([{
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkFixedSizeVirtualScroll, [{
        type: core.Directive,
        args: [{
    ...
    }], function () { return []; }, { _itemSize: [], _minBufferPx: [], _maxBufferPx: [], _scrollStrategy: [], itemSize: [{
            type: core.Input
        }], itemSize: [], minBufferPx: [{
            type: core.Input
        }], minBufferPx: [], maxBufferPx: [{
            type: core.Input
        }], maxBufferPx: [], ngOnChanges: [] });
...
ScrollDispatcher.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ScrollDispatcher, factory: function ScrollDispatcher_Factory(t) { return new (t || ScrollDispatcher)(ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(platform.Platform)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollDispatcher, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: core.NgZone }, { type: platform.Platform }]; }, { _ngZone: [], _platform: [], _scrolled: [], _globalSubscription: [], _scrolledCount: [], scrollContainers: [], register: [], deregister: [], scrolled: [], ngOnDestroy: [], ancestorScrolled: [], getAncestorScrollContainers: [], _scrollableContainsElement: [], _addGlobalListener: [], _removeGlobalListener: [] });
...
var SCROLL_DISPATCHER_PROVIDER = {
    ...
    deps: [[new core.Optional(), new core.SkipSelf(), ScrollDispatcher], core.NgZone, platform.Platform],
...
CdkScrollable.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkScrollable, selectors: [["", "cdk-scrollable", ""], ["", "cdkScrollable", ""]], factory: function CdkScrollable_Factory(t) { return new (t || CdkScrollable)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(ScrollDispatcher), ɵngcc0.ɵɵdirectiveInject(core.NgZone), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkScrollable, [{
        type: core.Directive,
        args: [{
                selector: '[cdk-scrollable], [cdkScrollable]'
            }]
    }], function () { return [{ type: core.ElementRef }, { type: ScrollDispatcher }, { type: core.NgZone }, { type: bidi.Directionality, decorators: [{
                type: core.Optional
            }] }]; }, { elementRef: [], scrollDispatcher: [], ngZone: [], dir: [], _destroyed: [], _elementScrolled: [], ngOnInit: [], ngOnDestroy: [], elementScrolled: [], getElementRef: [], scrollTo: [], _applyScrollToOptions: [], measureScrollOffset: [] });
...
var CdkVirtualScrollViewport = /** @class */ (function (_super) {
    ...
    CdkVirtualScrollViewport.propDecorators = {
        ...
        _contentWrapper: [{ type: core.ViewChild, args: ['contentWrapper', { static: true },] }]
    };
CdkVirtualScrollViewport.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CdkVirtualScrollViewport, selectors: [["cdk-virtual-scroll-viewport"]], factory: function CdkVirtualScrollViewport_Factory(t) { return new (t || CdkVirtualScrollViewport)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(core.NgZone), ɵngcc0.ɵɵdirectiveInject(VIRTUAL_SCROLL_STRATEGY, 8), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(ScrollDispatcher)); }, viewQuery: function CdkVirtualScrollViewport_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c0, true, null);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx._contentWrapper = _t.first);
    } }, hostBindings: function CdkVirtualScrollViewport_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵelementHostAttrs(_c1);
        ɵngcc0.ɵɵstyling(_c2);
    } if (rf & 2) {
        ɵngcc0.ɵɵclassProp(0, ctx.orientation === "horizontal");
        ɵngcc0.ɵɵclassProp(1, ctx.orientation !== "horizontal");
        ɵngcc0.ɵɵstylingApply();
            ...
            }]), ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c7, consts: 4, vars: 0, template: function CdkVirtualScrollViewport_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵselect(3);
        ɵngcc0.ɵɵstyleProp(0, ctx._totalContentWidth);
        ɵngcc0.ɵɵstyleProp(1, ctx._totalContentHeight);
        ɵngcc0.ɵɵstylingApply();
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkVirtualScrollViewport, [{
        type: core.Component,
        args: [{ selector: 'cdk-virtual-scroll-viewport',
    ...
    }], function () { return [{ type: core.ElementRef }, { type: core.ChangeDetectorRef }, { type: core.NgZone }, { type: undefined, decorators: [{
                type: core.Optional
            }, {
                type: core.Inject,
            ...
            type: core.Input
        }], orientation: [], ngOnInit: [], ngOnDestroy: [], attach: [], detach: [], _forOf: [], getDataLength: [], getViewportSize: [], getRenderedRange: [], setTotalContentSize: [], _totalContentSize: [], setRenderedRange: [], _renderedRange: [], getOffsetToRenderedContentStart: [], setRenderedContentOffset: [], _renderedContentOffset: [], _renderedContentOffsetNeedsRewrite: [], _renderedContentTransform: [], scrollToOffset: [], scrollToIndex: [], measureScrollOffset: [], measureRenderedContentSize: [], measureRangeSize: [], checkViewportSize: [], _measureViewportSize: [], _viewportSize: [], _markChangeDetectionNeeded: [], _isChangeDetectionPending: [], _doChangeDetection: [], _runAfterChangeDetection: [], _calculateSpacerSize: [], _totalContentHeight: [], _totalContentWidth: [], scrolledIndexChange: [{
            type: core.Output
        }], _contentWrapper: [{
            type: core.ViewChild,
...
CdkVirtualForOf.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkVirtualForOf, selectors: [["", "cdkVirtualFor", "", "cdkVirtualForOf", ""]], factory: function CdkVirtualForOf_Factory(t) { return new (t || CdkVirtualForOf)(ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(core.TemplateRef), ɵngcc0.ɵɵdirectiveInject(core.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(CdkVirtualScrollViewport, 4), ɵngcc0.ɵɵdirectiveInject(core.NgZone)); }, inputs: { cdkVirtualForTemplateCacheSize: "cdkVirtualForTemplateCacheSize", cdkVirtualForOf: "cdkVirtualForOf", cdkVirtualForTrackBy: "cdkVirtualForTrackBy", cdkVirtualForTemplate: "cdkVirtualForTemplate" } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkVirtualForOf, [{
        type: core.Directive,
        args: [{
                selector: '[cdkVirtualFor][cdkVirtualForOf]'
            }]
    }], function () { return [{ type: core.ViewContainerRef }, { type: core.TemplateRef }, { type: core.IterableDiffers }, { type: CdkVirtualScrollViewport, decorators: [{
                type: core.SkipSelf
            }] }, { type: core.NgZone }]; }, { _viewContainerRef: [], _template: [], _differs: [], _viewport: [], viewChange: [], _dataSourceChanges: [], cdkVirtualForTemplateCacheSize: [{
            type: core.Input
        }], dataStream: [], _differ: [], _templateCache: [], _needsUpdate: [], _destroyed: [], cdkVirtualForOf: [{
            type: core.Input
        }], cdkVirtualForOf: [], cdkVirtualForTrackBy: [{
            type: core.Input
        }], cdkVirtualForTrackBy: [], cdkVirtualForTemplate: [{
            type: core.Input
        }], measureRangeSize: [], ngDoCheck: [], ngOnDestroy: [], _onRenderedDataChange: [], _renderedItems: [], _changeDataSource: [], _updateContext: [], _applyChanges: [], _cacheView: [], _insertViewForNewItem: [], _updateComputedContextProperties: [], _createEmbeddedViewAt: [], _insertViewFromCache: [], _detachView: [] });
...
ScrollingModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: ScrollingModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ScrollingModule, { declarations: [CdkFixedSizeVirtualScroll,
        CdkScrollable,
        CdkVirtualForOf,
        CdkVirtualScrollViewport], imports: [ɵngcc1.BidiModule, ɵngcc2.PlatformModule], exports: [ɵngcc1.BidiModule, CdkFixedSizeVirtualScroll,
        CdkScrollable,
        CdkVirtualForOf,
        CdkVirtualScrollViewport] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollingModule, [{
        type: core.NgModule,
        args: [{
...
ScrollingModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ScrollingModule_Factory(t) { return new (t || ScrollingModule)(); }, imports: [[bidi.BidiModule, platform.PlatformModule], ɵngcc1.BidiModule] });
...
ScrollDispatchModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: ScrollDispatchModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ScrollDispatchModule, { imports: [ScrollingModule], exports: [ScrollingModule] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollDispatchModule, [{
        type: core.NgModule,
        args: [{
...
ScrollDispatchModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ScrollDispatchModule_Factory(t) { return new (t || ScrollDispatchModule)(); }, imports: [[ScrollingModule],
        ScrollingModule] });
...
ViewportRuler.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ViewportRuler, factory: function ViewportRuler_Factory(t) { return new (t || ViewportRuler)(ɵngcc0.ɵɵinject(platform.Platform), ɵngcc0.ɵɵinject(core.NgZone)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ViewportRuler, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: platform.Platform }, { type: core.NgZone }]; }, { _platform: [], ngOnDestroy: [], getViewportSize: [], _viewportSize: [], getViewportRect: [], getViewportScrollPosition: [], change: [], _updateViewportSize: [] });
