...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/cdk/portal'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('@angular/cdk/a11y'), require('@angular/material/core'), require('@angular/cdk/coercion'), require('@angular/cdk/keycodes'), require('rxjs/operators'), require('@angular/cdk/bidi'), require('@angular/cdk/overlay'), require('@angular/cdk/platform'),require('@angular/core'),require('@angular/material/core'),require('@angular/common'),require('@angular/cdk/overlay')) :
	typeof define === 'function' && define.amd ? define('@angular/material/menu', ['exports', '@angular/animations', '@angular/cdk/portal', '@angular/common', '@angular/core', 'rxjs', '@angular/cdk/a11y', '@angular/material/core', '@angular/cdk/coercion', '@angular/cdk/keycodes', 'rxjs/operators', '@angular/cdk/bidi', '@angular/cdk/overlay', '@angular/cdk/platform','@angular/core','@angular/material/core','@angular/common','@angular/cdk/overlay'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.menu = {}),global.ng.animations,global.ng.cdk.portal,global.ng.common,global.ng.core,global.rxjs,global.ng.cdk.a11y,global.ng.material.core,global.ng.cdk.coercion,global.ng.cdk.keycodes,global.rxjs.operators,global.ng.cdk.bidi,global.ng.cdk.overlay,global.ng.cdk.platform,global.ng.core,global.ng.material/core,global.ng.common,global.ng.cdk/overlay));
}(this, (function (exports,animations,portal,common,core,rxjs,a11y,core$1,coercion,keycodes,operators,bidi,overlay,platform,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3) { 
const _c0 = [1, "mat-menu-item"];
const _c1 = ["mat-menu-item-highlighted", "mat-menu-item-submenu-trigger"];
const _c2 = ["mat-menu-item", ""];
const _c3 = ["matRipple", "", 1, "mat-menu-ripple", 3, "matRippleDisabled", "matRippleTrigger"];
const _c4 = ["*"];
const _c5 = ["tabindex", "-1", "role", "menu", 1, "mat-menu-panel", 3, "ngClass", "keydown", "click"];
const _c6 = [1, "mat-menu-content"];
function _MatMenu_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function _MatMenu_ng_template_0_Template_div_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r194); const ctx_r193 = ɵngcc0.ɵɵnextContext(); return ctx_r193._handleKeydown($event); });
    ɵngcc0.ɵɵlistener("click", function _MatMenu_ng_template_0_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r194); const ctx_r195 = ɵngcc0.ɵɵnextContext(); return ctx_r195.closed.emit("click"); });
    ɵngcc0.ɵɵlistener("@transformMenu.start", function _MatMenu_ng_template_0_Template_div_animation_transformMenu_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r194); const ctx_r196 = ɵngcc0.ɵɵnextContext(); return ctx_r196._onAnimationStart($event); });
    ɵngcc0.ɵɵlistener("@transformMenu.done", function _MatMenu_ng_template_0_Template_div_animation_transformMenu_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r194); const ctx_r197 = ɵngcc0.ɵɵnextContext(); return ctx_r197._onAnimationDone($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r192._classList)("@transformMenu", ctx_r192._panelAnimationState);
} }
const _c7 = ["aria-haspopup", "true", 1, "mat-menu-trigger"];
'use strict';
...
MatMenuContent.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatMenuContent, selectors: [["ng-template", "matMenuContent", ""]], factory: function MatMenuContent_Factory(t) { return new (t || MatMenuContent)(ɵngcc0.ɵɵdirectiveInject(core.TemplateRef), ɵngcc0.ɵɵdirectiveInject(core.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(core.ApplicationRef), ɵngcc0.ɵɵdirectiveInject(core.Injector), ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatMenuContent, [{
        type: core.Directive,
        args: [{
                selector: 'ng-template[matMenuContent]'
            }]
    }], function () { return [{ type: core.TemplateRef }, { type: core.ComponentFactoryResolver }, { type: core.ApplicationRef }, { type: core.Injector }, { type: core.ViewContainerRef }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: core.ChangeDetectorRef }]; }, { _template: [], _componentFactoryResolver: [], _appRef: [], _injector: [], _viewContainerRef: [], _document: [], _changeDetectorRef: [], _attached: [], attach: [], _portal: [], _outlet: [], detach: [], ngOnDestroy: [] });
...
MatMenuItem.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatMenuItem, selectors: [["", "mat-menu-item", ""]], factory: function MatMenuItem_Factory(t) { return new (t || MatMenuItem)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT), ɵngcc0.ɵɵdirectiveInject(a11y.FocusMonitor), ɵngcc0.ɵɵdirectiveInject(MAT_MENU_PANEL, 8)); }, hostBindings: function MatMenuItem_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵclassProp(0, ctx._highlighted);
        ɵngcc0.ɵɵclassProp(1, ctx._triggersSubmenu);
        ɵngcc0.ɵɵstylingApply();
    } }, inputs: { disabled: "disabled", disableRipple: "disableRipple", role: "role" }, exportAs: ["matMenuItem"], features: [ɵngcc0.ɵɵInheritDefinitionFeature], attrs: _c2, ngContentSelectors: _c4, consts: 2, vars: 2, template: function MatMenuItem_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵprojection(0);
        ɵngcc0.ɵɵelement(1, "div", _c3);
    } if (rf & 2) {
        ɵngcc0.ɵɵselect(1);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatMenuItem, [{
        ...
        args: [{ selector: '[mat-menu-item]',
                ...
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: a11y.FocusMonitor }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [MAT_MENU_PANEL]
            }, {
                type: core.Optional
            }] }]; }, { focus: [], ngOnDestroy: [], _getTabIndex: [], _getHostElement: [], _checkDisabled: [{
...
_MatMenuBase.ngBaseDef = ɵngcc0.ɵɵdefineBase({ inputs: { backdropClass: "backdropClass", xPosition: "xPosition", yPosition: "yPosition", overlapTrigger: "overlapTrigger", hasBackdrop: "hasBackdrop", panelClass: ["class", "panelClass"], classList: "classList" }, outputs: { closed: "closed", close: "close" }, viewQuery: function (rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(core.TemplateRef, true, null);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.templateRef = _t.first);
    } }, contentQueries: function (rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, MatMenuItem, true, null);
        ɵngcc0.ɵɵcontentQuery(dirIndex, MatMenuItem, false, null);
        ɵngcc0.ɵɵcontentQuery(dirIndex, MatMenuContent, true, null);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadContentQuery()) && (ctx._allItems = _t);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadContentQuery()) && (ctx.items = _t);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadContentQuery()) && (ctx.lazyContent = _t.first);
    } } });
    return _MatMenuBase;
}());
/**
...
_MatMenu.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: _MatMenu, selectors: [["mat-menu"]], factory: function _MatMenu_Factory(t) { return new (t || _MatMenu)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.NgZone), ɵngcc0.ɵɵdirectiveInject(MAT_MENU_DEFAULT_OPTIONS)); }, exportAs: ["matMenu"], features: [ɵngcc0.ɵɵProvidersFeature([
            { provide: MAT_MENU_PANEL, useExisting: MatMenu },
            { provide: MatMenu, useExisting: _MatMenu }
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c4, consts: 1, vars: 0, template: function _MatMenu_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
...
MatMenuTrigger.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatMenuTrigger, selectors: [["", "mat-menu-trigger-for", ""], ["", "matMenuTriggerFor", ""]], factory: function MatMenuTrigger_Factory(t) { return new (t || MatMenuTrigger)(ɵngcc0.ɵɵdirectiveInject(overlay.Overlay), ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(MAT_MENU_SCROLL_STRATEGY), ɵngcc0.ɵɵdirectiveInject(MatMenu, 8), ɵngcc0.ɵɵdirectiveInject(MatMenuItem, 10), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(a11y.FocusMonitor)); }, hostBindings: function MatMenuTrigger_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatMenuTrigger, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: overlay.Overlay }, { type: core.ElementRef }, { type: core.ViewContainerRef }, { type: undefined, decorators: [{
                type: core.Inject,
                ...
                type: core.Optional
            }] }, { type: a11y.FocusMonitor }]; }, { _overlay: [], _element: [], _viewContainerRef: [], _parentMenu: [], _menuItemInstance: [], _dir: [], _focusMonitor: [], _overlayRef: [], _menuOpen: [], _closingActionsSubscription: [], _hoverSubscription: [], _menuCloseSubscription: [], _handleTouchStart: [], _openedBy: [], restoreFocus: [{
            type: core.Input,
        ...
        }], menu: [], ngAfterContentInit: [], ngOnDestroy: [], menuOpen: [], dir: [], triggersSubmenu: [], toggleMenu: [], openMenu: [], closeMenu: [], focus: [], _destroyMenu: [], _initMenu: [], _setMenuElevation: [], _restoreFocus: [], _setIsMenuOpen: [], _checkMenu: [], _createOverlay: [], _getOverlayConfig: [], _subscribeToPositions: [], _setPosition: [], _menuClosingActions: [], _handleMousedown: [], _handleKeydown: [], _handleClick: [], _handleHover: [], _getPortal: [], _portal: [], menuData: [{
            type: core.Input,
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(_MatMenuDirectivesModule, { declarations: [MatMenuTrigger,
        MatMenuContent], exports: [MatMenuTrigger,
        MatMenuContent, ɵngcc1.MatCommonModule] });
...
_MatMenuDirectivesModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function _MatMenuDirectivesModule_Factory(t) { return new (t || _MatMenuDirectivesModule)(); }, providers: [MAT_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER], imports: [ɵngcc1.MatCommonModule] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatMenuModule, { declarations: [_MatMenu,
        MatMenuItem], imports: [ɵngcc2.CommonModule, ɵngcc1.MatCommonModule, ɵngcc1.MatRippleModule, ɵngcc3.OverlayModule, _MatMenuDirectivesModule], exports: [_MatMenu,
        MatMenuItem,
