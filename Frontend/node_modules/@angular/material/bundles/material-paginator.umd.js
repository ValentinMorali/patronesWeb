...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/cdk/coercion'), require('@angular/material/core'), require('@angular/common'), require('@angular/material/button'), require('@angular/material/select'), require('@angular/material/tooltip'),require('@angular/core'),require('@angular/common'),require('@angular/material/button'),require('@angular/material/tooltip'),require('@angular/material/form-field'),require('@angular/material/select'),require('@angular/material/core')) :
	typeof define === 'function' && define.amd ? define('@angular/material/paginator', ['exports', '@angular/core', 'rxjs', '@angular/cdk/coercion', '@angular/material/core', '@angular/common', '@angular/material/button', '@angular/material/select', '@angular/material/tooltip','@angular/core','@angular/common','@angular/material/button','@angular/material/tooltip','@angular/material/form-field','@angular/material/select','@angular/material/core'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.paginator = {}),global.ng.core,global.rxjs,global.ng.cdk.coercion,global.ng.material.core,global.ng.common,global.ng.material.button,global.ng.material.select,global.ng.material.tooltip,global.ng.core,global.ng.common,global.ng.material/button,global.ng.material/tooltip,global.ng.material/form-field,global.ng.material/select,global.ng.material/core));
}(this, (function (exports,core,rxjs,coercion,core$1,common,button,select,tooltip,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6) { 
...
const _c6 = ["mat-icon-button", "", "type", "button", "class", "mat-paginator-navigation-first", 3, "aria-label", "matTooltip", "matTooltipDisabled", "matTooltipPosition", "disabled", "click", 4, "ngIf"];
const _c7 = ["mat-icon-button", "", "type", "button", 1, "mat-paginator-navigation-previous", 3, "aria-label", "matTooltip", "matTooltipDisabled", "matTooltipPosition", "disabled", "click"];
...
const _c10 = ["mat-icon-button", "", "type", "button", 1, "mat-paginator-navigation-next", 3, "aria-label", "matTooltip", "matTooltipDisabled", "matTooltipPosition", "disabled", "click"];
const _c11 = ["d", "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"];
const _c12 = ["mat-icon-button", "", "type", "button", "class", "mat-paginator-navigation-last", 3, "aria-label", "matTooltip", "matTooltipDisabled", "matTooltipPosition", "disabled", "click", 4, "ngIf"];
...
function MatPaginator_div_2_mat_form_field_3_mat_option_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const pageSizeOption_r256 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("value", pageSizeOption_r256);
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵtextInterpolate(pageSizeOption_r256);
} }
function MatPaginator_div_2_mat_form_field_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("selectionChange", function MatPaginator_div_2_mat_form_field_3_Template_mat_select_selectionChange_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r258); const ctx_r257 = ɵngcc0.ɵɵnextContext(2); return ctx_r257._changePageSize($event.value); });
    ...
    ɵngcc0.ɵɵproperty("color", ctx_r253.color);
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵproperty("value", ctx_r253.pageSize)("disabled", ctx_r253.disabled)("aria-label", ctx_r253._intl.itemsPerPageLabel);
    ɵngcc0.ɵɵselect(2);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r253._displayedPageSizeOptions);
} }
function MatPaginator_div_2_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r254.pageSize);
} }
function MatPaginator_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵselect(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r250._intl.itemsPerPageLabel);
    ɵngcc0.ɵɵselect(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r250._displayedPageSizeOptions.length > 1);
    ɵngcc0.ɵɵselect(4);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r250._displayedPageSizeOptions.length <= 1);
} }
const _c21 = ["mat-icon-button", "", "type", "button", 1, "mat-paginator-navigation-first", 3, "aria-label", "matTooltip", "matTooltipDisabled", "matTooltipPosition", "disabled", "click"];
...
function MatPaginator_button_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatPaginator_button_6_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r260); const ctx_r259 = ɵngcc0.ɵɵnextContext(); return ctx_r259.firstPage(); });
    ...
    ɵngcc0.ɵɵproperty("matTooltip", ctx_r251._intl.firstPageLabel)("matTooltipDisabled", ctx_r251._previousButtonsDisabled())("matTooltipPosition", "above")("disabled", ctx_r251._previousButtonsDisabled());
    ɵngcc0.ɵɵattribute("aria-label", ctx_r251._intl.firstPageLabel);
} }
const _c23 = ["mat-icon-button", "", "type", "button", 1, "mat-paginator-navigation-last", 3, "aria-label", "matTooltip", "matTooltipDisabled", "matTooltipPosition", "disabled", "click"];
...
function MatPaginator_button_13_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatPaginator_button_13_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r262); const ctx_r261 = ɵngcc0.ɵɵnextContext(); return ctx_r261.lastPage(); });
    ɵngcc0.ɵɵnamespaceSVG();
    ɵngcc0.ɵɵelementStart(1, "svg", _c8);
    ...
    ɵngcc0.ɵɵproperty("matTooltip", ctx_r252._intl.lastPageLabel)("matTooltipDisabled", ctx_r252._nextButtonsDisabled())("matTooltipPosition", "above")("disabled", ctx_r252._nextButtonsDisabled());
    ɵngcc0.ɵɵattribute("aria-label", ctx_r252._intl.lastPageLabel);
} }
'use strict';
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatPaginatorIntl, [{
    ...
    }], function () { return []; }, { changes: [], itemsPerPageLabel: [], nextPageLabel: [], previousPageLabel: [], firstPageLabel: [], lastPageLabel: [], getRangeLabel: [] });
...
MatPaginator.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatPaginator, selectors: [["mat-paginator"]], factory: function MatPaginator_Factory(t) { return new (t || MatPaginator)(ɵngcc0.ɵɵdirectiveInject(MatPaginatorIntl), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef)); }, hostBindings: function MatPaginator_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatPaginator, [{
        ...
        args: [{ selector: 'mat-paginator',
    ...
    }], function () { return [{ type: MatPaginatorIntl }, { type: core.ChangeDetectorRef }]; }, { pageIndex: [{
            type: core.Input
        }], pageIndex: [], length: [{
            type: core.Input
        }], length: [], pageSize: [{
            ...
            type: core.Input
        }], showFirstLastButtons: [], ngOnInit: [], _initialized: [], ngOnDestroy: [], nextPage: [], previousPage: [], firstPage: [], lastPage: [], hasPreviousPage: [], hasNextPage: [], getNumberOfPages: [], _changePageSize: [], _nextButtonsDisabled: [], _previousButtonsDisabled: [], _updateDisplayedPageSizeOptions: [], _pageSize: [], _displayedPageSizeOptions: [], _emitPageEvent: [], color: [{
            type: core.Input
        }], page: [{
            type: core.Output
        }] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatPaginatorModule, { declarations: [MatPaginator], imports: [ɵngcc1.CommonModule, ɵngcc2.MatButtonModule, ɵngcc5.MatSelectModule, ɵngcc3.MatTooltipModule], exports: [MatPaginator] });
