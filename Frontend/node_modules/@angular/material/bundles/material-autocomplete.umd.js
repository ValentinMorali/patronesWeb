...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/a11y'), require('@angular/cdk/coercion'), require('@angular/core'), require('@angular/material/core'), require('@angular/cdk/bidi'), require('@angular/cdk/keycodes'), require('@angular/cdk/overlay'), require('@angular/cdk/platform'), require('@angular/cdk/portal'), require('@angular/cdk/scrolling'), require('@angular/common'), require('@angular/forms'), require('@angular/material/form-field'), require('rxjs'), require('rxjs/operators'),require('@angular/core'),require('@angular/common'),require('@angular/material/core'),require('@angular/cdk/overlay')) :
	typeof define === 'function' && define.amd ? define('@angular/material/autocomplete', ['exports', '@angular/cdk/a11y', '@angular/cdk/coercion', '@angular/core', '@angular/material/core', '@angular/cdk/bidi', '@angular/cdk/keycodes', '@angular/cdk/overlay', '@angular/cdk/platform', '@angular/cdk/portal', '@angular/cdk/scrolling', '@angular/common', '@angular/forms', '@angular/material/form-field', 'rxjs', 'rxjs/operators','@angular/core','@angular/common','@angular/material/core','@angular/cdk/overlay'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.autocomplete = {}),global.ng.cdk.a11y,global.ng.cdk.coercion,global.ng.core,global.ng.material.core,global.ng.cdk.bidi,global.ng.cdk.keycodes,global.ng.cdk.overlay,global.ng.cdk.platform,global.ng.cdk.portal,global.ng.cdk.scrolling,global.ng.common,global.ng.forms,global.ng.material.formField,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.common,global.ng.material/core,global.ng.cdk/overlay));
}(this, (function (exports,a11y,coercion,core,core$1,bidi,keycodes,overlay,platform,portal,scrolling,common,forms,formField,rxjs,operators,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3) { 
const _c0 = ["panel"];
...
function MatAutocomplete_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("id", ctx_r59.id)("ngClass", ctx_r59._classList);
} }
const _c4 = ["*"];
const _c5 = [1, "mat-autocomplete-trigger"];
'use strict';
...
MatAutocomplete.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatAutocomplete, selectors: [["mat-autocomplete"]], factory: function MatAutocomplete_Factory(t) { return new (t || MatAutocomplete)(ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(MAT_AUTOCOMPLETE_DEFAULT_OPTIONS)); }, contentQueries: function MatAutocomplete_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.template = _t.first);
    ...
    } }, inputs: { disableRipple: "disableRipple", autoActiveFirstOption: "autoActiveFirstOption", classList: ["class", "classList"], displayWith: "displayWith", panelWidth: "panelWidth" }, outputs: { optionSelected: "optionSelected", opened: "opened", closed: "closed" }, exportAs: ["matAutocomplete"], features: [ɵngcc0.ɵɵProvidersFeature([
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatAutocomplete, [{
    ...
    }], function () { return [{ type: core.ChangeDetectorRef }, { type: core.ElementRef }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [MAT_AUTOCOMPLETE_DEFAULT_OPTIONS]
            }] }]; }, { isOpen: [], autoActiveFirstOption: [{
            type: core.Input
        }], autoActiveFirstOption: [], classList: [{
            type: core.Input,
            args: ['class']
        }], ngAfterContentInit: [], _keyManager: [], _setScrollTop: [], _getScrollTop: [], _setVisibility: [], showPanel: [], _emitSelectEvent: [], _setVisibilityClasses: [], template: [{
            type: core.ViewChild,
...
MatAutocompleteOrigin.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatAutocompleteOrigin, selectors: [["", "matAutocompleteOrigin", ""]], factory: function MatAutocompleteOrigin_Factory(t) { return new (t || MatAutocompleteOrigin)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef)); }, exportAs: ["matAutocompleteOrigin"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatAutocompleteOrigin, [{
    ...
    }], function () { return [{ type: core.ElementRef }]; }, { elementRef: [] });
...
MatAutocompleteTrigger.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatAutocompleteTrigger, selectors: [["input", "matAutocomplete", ""], ["textarea", "matAutocomplete", ""]], factory: function MatAutocompleteTrigger_Factory(t) { return new (t || MatAutocompleteTrigger)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(overlay.Overlay), ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(core.NgZone), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(MAT_AUTOCOMPLETE_SCROLL_STRATEGY), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(formField.MatFormField, 9), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT, 8), ɵngcc0.ɵɵdirectiveInject(scrolling.ViewportRuler)); }, hostBindings: function MatAutocompleteTrigger_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵattribute("autocomplete", ctx.autocompleteAttribute);
        ɵngcc0.ɵɵattribute("role", ctx.autocompleteDisabled ? null : "combobox");
        ɵngcc0.ɵɵattribute("aria-autocomplete", ctx.autocompleteDisabled ? null : "list");
        ɵngcc0.ɵɵattribute("aria-activedescendant", ctx.panelOpen && ctx.activeOption ? ctx.activeOption.id : null);
        ɵngcc0.ɵɵattribute("aria-expanded", ctx.autocompleteDisabled ? null : ctx.panelOpen.toString());
        ɵngcc0.ɵɵattribute("aria-owns", ctx.autocompleteDisabled || !ctx.panelOpen ? null : ctx.autocomplete == null ? null : ctx.autocomplete.id);
        ɵngcc0.ɵɵattribute("aria-haspopup", !ctx.autocompleteDisabled);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatAutocompleteTrigger, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: overlay.Overlay }, { type: core.ViewContainerRef }, { type: core.NgZone }, { type: core.ChangeDetectorRef }, { type: undefined, decorators: [{
                type: core.Inject,
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatAutocompleteModule, { declarations: [MatAutocomplete,
        MatAutocompleteTrigger,
        MatAutocompleteOrigin], imports: [ɵngcc2.MatOptionModule, ɵngcc3.OverlayModule, ɵngcc2.MatCommonModule, ɵngcc1.CommonModule], exports: [MatAutocomplete, ɵngcc2.MatOptionModule, MatAutocompleteTrigger,
        MatAutocompleteOrigin, ɵngcc2.MatCommonModule] });
...
MatAutocompleteModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function MatAutocompleteModule_Factory(t) { return new (t || MatAutocompleteModule)(); }, providers: [MAT_AUTOCOMPLETE_SCROLL_STRATEGY_FACTORY_PROVIDER], imports: [[core$1.MatOptionModule, overlay.OverlayModule, core$1.MatCommonModule, common.CommonModule], ɵngcc2.MatOptionModule, ɵngcc2.MatCommonModule] });
