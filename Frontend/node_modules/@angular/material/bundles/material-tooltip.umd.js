...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/cdk/a11y'), require('@angular/cdk/bidi'), require('@angular/cdk/coercion'), require('@angular/cdk/keycodes'), require('@angular/cdk/layout'), require('@angular/cdk/overlay'), require('@angular/cdk/platform'), require('@angular/cdk/portal'), require('@angular/cdk/scrolling'), require('@angular/core'), require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/material/core'),require('@angular/core'),require('@angular/common'),require('@angular/cdk/a11y'),require('@angular/cdk/overlay'),require('@angular/material/core')) :
	typeof define === 'function' && define.amd ? define('@angular/material/tooltip', ['exports', '@angular/animations', '@angular/cdk/a11y', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/keycodes', '@angular/cdk/layout', '@angular/cdk/overlay', '@angular/cdk/platform', '@angular/cdk/portal', '@angular/cdk/scrolling', '@angular/core', '@angular/platform-browser', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/material/core','@angular/core','@angular/common','@angular/cdk/a11y','@angular/cdk/overlay','@angular/material/core'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.tooltip = {}),global.ng.animations,global.ng.cdk.a11y,global.ng.cdk.bidi,global.ng.cdk.coercion,global.ng.cdk.keycodes,global.ng.cdk.layout,global.ng.cdk.overlay,global.ng.cdk.platform,global.ng.cdk.portal,global.ng.cdk.scrolling,global.ng.core,global.ng.platformBrowser,global.rxjs,global.rxjs.operators,global.ng.common,global.ng.material.core,global.ng.core,global.ng.common,global.ng.cdk/a11y,global.ng.cdk/overlay,global.ng.material/core));
}(this, (function (exports,animations,a11y,bidi,coercion,keycodes,layout,overlay,platform,portal,scrolling,core,platformBrowser,rxjs,operators,common,core$1,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4) { 
const _c0 = ["aria-hidden", "true"];
const _c1 = ["zoom"];
const _c2 = [1, "mat-tooltip", 3, "ngClass"];
const _c3 = ["mat-tooltip-handset"];
'use strict';
...
MatTooltip.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatTooltip, selectors: [["", "matTooltip", ""]], factory: function MatTooltip_Factory(t) { return new (t || MatTooltip)(ɵngcc0.ɵɵdirectiveInject(overlay.Overlay), ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(scrolling.ScrollDispatcher), ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(core.NgZone), ɵngcc0.ɵɵdirectiveInject(platform.Platform), ɵngcc0.ɵɵdirectiveInject(a11y.AriaDescriber), ɵngcc0.ɵɵdirectiveInject(a11y.FocusMonitor), ɵngcc0.ɵɵdirectiveInject(MAT_TOOLTIP_SCROLL_STRATEGY), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(MAT_TOOLTIP_DEFAULT_OPTIONS, 8), ɵngcc0.ɵɵdirectiveInject(platformBrowser.HAMMER_LOADER, 8)); }, hostBindings: function MatTooltip_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("longpress", function MatTooltip_longpress_HostBindingHandler($event) { return ctx.show(); });
        ɵngcc0.ɵɵlistener("keydown", function MatTooltip_keydown_HostBindingHandler($event) { return ctx._handleKeydown($event); });
        ɵngcc0.ɵɵlistener("touchend", function MatTooltip_touchend_HostBindingHandler($event) { return ctx._handleTouchend(); });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatTooltip, [{
        type: core.Directive,
        args: [{
                selector: '[matTooltip]',
                exportAs: 'matTooltip',
    ...
    }], function () { return [{ type: overlay.Overlay }, { type: core.ElementRef }, { type: scrolling.ScrollDispatcher }, { type: core.ViewContainerRef }, { type: core.NgZone }, { type: platform.Platform }, { type: a11y.AriaDescriber }, { type: a11y.FocusMonitor }, { type: undefined, decorators: [{
                type: core.Inject,
            ...
            }] }]; }, { _overlay: [], _elementRef: [], _scrollDispatcher: [], _viewContainerRef: [], _ngZone: [], _ariaDescriber: [], _focusMonitor: [], _dir: [], _defaultOptions: [], _position: [], _disabled: [], showDelay: [{
            type: core.Input,
            args: ['matTooltipShowDelay']
        }], hideDelay: [{
            type: core.Input,
            args: ['matTooltipHideDelay']
        }], _message: [], _manualListeners: [], _destroyed: [], _scrollStrategy: [], position: [{
            type: core.Input,
        ...
        }], tooltipClass: [], ngOnInit: [], ngOnDestroy: [], _tooltipInstance: [], show: [], _portal: [], hide: [], toggle: [], _isTooltipVisible: [], _handleKeydown: [], _handleTouchend: [], _createOverlay: [], _overlayRef: [], _detach: [], _updatePosition: [], _getOrigin: [], _getOverlayPosition: [], _updateTooltipMessage: [], _setTooltipClass: [], _invertPosition: [] });
    return MatTooltip;
}());
/**
...
TooltipComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: TooltipComponent, selectors: [["mat-tooltip-component"]], factory: function TooltipComponent_Factory(t) { return new (t || TooltipComponent)(ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(layout.BreakpointObserver)); }, hostBindings: function TooltipComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵstyleProp(0, ctx._visibility === "visible" ? 1 : null);
        ɵngcc0.ɵɵstylingApply();
    } }, consts: 3, vars: 5, template: function TooltipComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "div", _c2);
        ɵngcc0.ɵɵstyling(_c3);
        ɵngcc0.ɵɵlistener("@state.start", function TooltipComponent_Template_div_animation_state_start_0_listener($event) { return ctx._animationStart(); });
        ɵngcc0.ɵɵlistener("@state.done", function TooltipComponent_Template_div_animation_state_done_0_listener($event) { return ctx._animationDone($event); });
        ɵngcc0.ɵɵpipe(1, "async");
        ɵngcc0.ɵɵtext(2);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        var tmp_0_0 = null;
        const currVal_0 = (tmp_0_0 = ɵngcc0.ɵɵpipeBind1(1, 3, ctx._isHandset)) == null ? null : tmp_0_0.matches;
        ɵngcc0.ɵɵclassProp(0, currVal_0);
        ɵngcc0.ɵɵstylingApply();
        ɵngcc0.ɵɵproperty("ngClass", ctx.tooltipClass)("@state", ctx._visibility);
        ɵngcc0.ɵɵselect(2);
        ɵngcc0.ɵɵtextInterpolate(ctx.message);
    } }, directives: [ɵngcc1.NgClass], pipes: [ɵngcc1.AsyncPipe], styles: [".mat-tooltip-panel{pointer-events:none!important}.mat-tooltip{color:#fff;border-radius:4px;margin:14px;max-width:250px;padding-left:8px;padding-right:8px;overflow:hidden;text-overflow:ellipsis}@media (-ms-high-contrast:active){.mat-tooltip{outline:solid 1px}}.mat-tooltip-handset{margin:24px;padding-left:16px;padding-right:16px}"], encapsulation: 2, data: { animation: [matTooltipAnimations.tooltipState] }, changeDetection: 0 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(TooltipComponent, [{
        type: core.Component,
    ...
    }], function () { return [{ type: core.ChangeDetectorRef }, { type: layout.BreakpointObserver }]; }, { _changeDetectorRef: [], _breakpointObserver: [], _visibility: [], _closeOnInteraction: [], _onHide: [], _isHandset: [], show: [], _hideTimeoutId: [], _showTimeoutId: [], hide: [], afterHidden: [], isVisible: [], ngOnDestroy: [], _animationStart: [], _animationDone: [], _handleBodyInteraction: [], _markForCheck: [] });
...
MatTooltipModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: MatTooltipModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatTooltipModule, { declarations: [MatTooltip,
        TooltipComponent], imports: [ɵngcc2.A11yModule, ɵngcc1.CommonModule, ɵngcc3.OverlayModule, ɵngcc4.MatCommonModule], exports: [MatTooltip,
        TooltipComponent, ɵngcc4.MatCommonModule] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatTooltipModule, [{
        type: core.NgModule,
        args: [{
                imports: [
                    a11y.A11yModule,
...
MatTooltipModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function MatTooltipModule_Factory(t) { return new (t || MatTooltipModule)(); }, providers: [
        MAT_TOOLTIP_SCROLL_STRATEGY_FACTORY_PROVIDER,
        { provide: platformBrowser.HAMMER_GESTURE_CONFIG, useClass: core$1.GestureConfig },
    ], imports: [[
            a11y.A11yModule,
