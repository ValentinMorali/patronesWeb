...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/coercion'), require('@angular/material/core'),require('@angular/core'),require('@angular/material/core')) :
	typeof define === 'function' && define.amd ? define('@angular/material/icon', ['exports', '@angular/common', '@angular/common/http', '@angular/core', '@angular/platform-browser', 'rxjs', 'rxjs/operators', '@angular/cdk/coercion', '@angular/material/core','@angular/core','@angular/material/core'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.icon = {}),global.ng.common,global.ng.common.http,global.ng.core,global.ng.platformBrowser,global.rxjs,global.rxjs.operators,global.ng.cdk.coercion,global.ng.material.core,global.ng.core,global.ng.material/core));
}(this, (function (exports,common,http,core,platformBrowser,rxjs,operators,coercion,core$1,ɵngcc0,ɵngcc1) { 
const _c0 = ["role", "img", 1, "mat-icon", "notranslate"];
const _c1 = ["mat-icon-inline", "mat-icon-no-color"];
const _c2 = ["*"];
'use strict';
...
MatIconRegistry.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: MatIconRegistry, factory: function MatIconRegistry_Factory(t) { return new (t || MatIconRegistry)(ɵngcc0.ɵɵinject(http.HttpClient, 8), ɵngcc0.ɵɵinject(platformBrowser.DomSanitizer), ɵngcc0.ɵɵinject(common.DOCUMENT, 8), ɵngcc0.ɵɵinject(core.ErrorHandler, 8)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatIconRegistry, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: http.HttpClient, decorators: [{
                type: core.Optional
            }] }, { type: platformBrowser.DomSanitizer }, { type: undefined, decorators: [{
                type: core.Optional
            }, {
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: core.ErrorHandler, decorators: [{
                type: core.Optional
            }] }]; }, { _httpClient: [], _sanitizer: [], _errorHandler: [], _svgIconConfigs: [], _iconSetConfigs: [], _cachedIconsByUrl: [], _inProgressUrlFetches: [], _fontCssClassesByAlias: [], _defaultFontSetClass: [], _document: [], addSvgIcon: [], addSvgIconLiteral: [], addSvgIconInNamespace: [], addSvgIconLiteralInNamespace: [], addSvgIconSet: [], addSvgIconSetLiteral: [], addSvgIconSetInNamespace: [], addSvgIconSetLiteralInNamespace: [], registerFontClassAlias: [], classNameForFontAlias: [], setDefaultFontSetClass: [], getDefaultFontSetClass: [], getSvgIconFromUrl: [], getNamedSvgIcon: [], ngOnDestroy: [], _getSvgFromConfig: [], _getSvgFromIconSetConfigs: [], _extractIconWithNameFromAnySet: [], _loadSvgIconFromConfig: [], _loadSvgIconSetFromConfig: [], _createSvgElementForSingleIcon: [], _extractSvgIconFromSet: [], _svgElementFromString: [], _toSvgElement: [], _setSvgAttributes: [], _fetchUrl: [], _addSvgIconConfig: [], _addSvgIconSetConfig: [] });
...
MatIcon.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatIcon, selectors: [["mat-icon"]], factory: function MatIcon_Factory(t) { return new (t || MatIcon)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(MatIconRegistry), ɵngcc0.ɵɵinjectAttribute('aria-hidden'), ɵngcc0.ɵɵdirectiveInject(MAT_ICON_LOCATION, 8), ɵngcc0.ɵɵdirectiveInject(core.ErrorHandler, 8)); }, hostBindings: function MatIcon_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵelementHostAttrs(_c0);
        ɵngcc0.ɵɵstyling(_c1);
    } if (rf & 2) {
        ɵngcc0.ɵɵclassProp(0, ctx.inline);
        ɵngcc0.ɵɵclassProp(1, ctx.color !== "primary" && ctx.color !== "accent" && ctx.color !== "warn");
        ɵngcc0.ɵɵstylingApply();
    } }, inputs: { color: "color", inline: "inline", fontSet: "fontSet", fontIcon: "fontIcon", svgIcon: "svgIcon" }, exportAs: ["matIcon"], features: [ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c2, consts: 1, vars: 0, template: function MatIcon_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatIcon, [{
        type: core.Component,
        args: [{ template: '<ng-content></ng-content>',
    ...
    }], function () { return [{ type: core.ElementRef }, { type: MatIconRegistry }, { type: String, decorators: [{
                type: core.Attribute,
                args: ['aria-hidden']
            ...
            type: core.Input
        }], fontIcon: [], _splitIconName: [], ngOnChanges: [], ngOnInit: [], ngAfterViewChecked: [], _previousPath: [], ngOnDestroy: [], _usingFontIcon: [], _setSvgElement: [], _clearSvgElement: [], _updateFontIconClasses: [], _previousFontSetClass: [], _previousFontIconClass: [], _cleanupFontValue: [], _prependPathToReferences: [], _cacheChildrenWithExternalReferences: [], _elementsWithExternalReferences: [], svgIcon: [{
            type: core.Input
        }] });
    return MatIcon;
}(_MatIconMixinBase));
...
MatIconModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: MatIconModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatIconModule, { declarations: [MatIcon], imports: [ɵngcc1.MatCommonModule], exports: [MatIcon, ɵngcc1.MatCommonModule] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatIconModule, [{
        type: core.NgModule,
        args: [{
...
MatIconModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function MatIconModule_Factory(t) { return new (t || MatIconModule)(); }, imports: [[core$1.MatCommonModule], ɵngcc1.MatCommonModule] });
