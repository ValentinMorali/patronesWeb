...
function _MatMenu_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function _MatMenu_ng_template_0_Template_div_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r200); const ctx_r199 = ɵngcc0.ɵɵnextContext(); return ctx_r199._handleKeydown($event); });
    ɵngcc0.ɵɵlistener("click", function _MatMenu_ng_template_0_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r200); const ctx_r201 = ɵngcc0.ɵɵnextContext(); return ctx_r201.closed.emit("click"); });
    ɵngcc0.ɵɵlistener("@transformMenu.start", function _MatMenu_ng_template_0_Template_div_animation_transformMenu_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r200); const ctx_r202 = ɵngcc0.ɵɵnextContext(); return ctx_r202._onAnimationStart($event); });
    ɵngcc0.ɵɵlistener("@transformMenu.done", function _MatMenu_ng_template_0_Template_div_animation_transformMenu_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r200); const ctx_r203 = ɵngcc0.ɵɵnextContext(); return ctx_r203._onAnimationDone($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r198._classList)("@transformMenu", ctx_r198._panelAnimationState);
} }
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatMenuContent, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: ChangeDetectorRef }]; }, { _template: [], _componentFactoryResolver: [], _appRef: [], _injector: [], _viewContainerRef: [], _document: [], _changeDetectorRef: [], _attached: [], attach: [], _portal: [], _outlet: [], detach: [], ngOnDestroy: [] });
...
_MatMenuBase.ngBaseDef = ɵngcc0.ɵɵdefineBase({ inputs: { backdropClass: "backdropClass", xPosition: "xPosition", yPosition: "yPosition", overlapTrigger: "overlapTrigger", hasBackdrop: "hasBackdrop", panelClass: ["class", "panelClass"], classList: "classList" }, outputs: { closed: "closed", close: "close" }, viewQuery: function (rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(TemplateRef, true, null);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatMenuTrigger, [{
        ...
        args: [{
                ...
                type: Optional
            }] }, { type: FocusMonitor }]; }, { _overlay: [], _element: [], _viewContainerRef: [], _parentMenu: [], _menuItemInstance: [], _dir: [], _focusMonitor: [], _overlayRef: [], _menuOpen: [], _closingActionsSubscription: [], _hoverSubscription: [], _menuCloseSubscription: [], _handleTouchStart: [], _openedBy: [], restoreFocus: [{
            type: Input,
