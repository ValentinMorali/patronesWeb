...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(TooltipComponent, [{
    ...
    }], function () { return [{ type: ChangeDetectorRef }, { type: BreakpointObserver }]; }, { _changeDetectorRef: [], _breakpointObserver: [], _visibility: [], _closeOnInteraction: [], _onHide: [], _isHandset: [], show: [], _hideTimeoutId: [], _showTimeoutId: [], hide: [], afterHidden: [], isVisible: [], ngOnDestroy: [], _animationStart: [], _animationDone: [], _handleBodyInteraction: [], _markForCheck: [] });
