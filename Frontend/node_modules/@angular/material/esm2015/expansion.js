...
const _c2 = ["mat-expanded", "_mat-animation-noopable", "mat-expansion-panel-spacing"];
const _c3 = ["role", "region", 1, "mat-expansion-panel-content", 3, "aria-labelledby", "id"];
const _c4 = ["body", ""];
const _c5 = [1, "mat-expansion-panel-body"];
const _c6 = [3, "cdkPortalOutlet"];
function MatExpansionPanel_ng_template_5_Template(rf, ctx) { }
const _c7 = [[["mat-expansion-panel-header"]], "*", [["mat-action-row"]]];
const _c8 = ["mat-expansion-panel-header", "*", "mat-action-row"];
const _c9 = [1, "mat-action-row"];
const _c10 = function (a0, a1) { return { collapsedHeight: a0, expandedHeight: a1 }; };
const _c11 = function (a0, a1) { return { value: a0, params: a1 }; };
const _c12 = ["role", "button", 1, "mat-expansion-panel-header"];
const _c13 = ["mat-expanded", "mat-expansion-toggle-indicator-after", "mat-expansion-toggle-indicator-before"];
const _c14 = [1, "mat-content"];
const _c15 = ["class", "mat-expansion-indicator", 4, "ngIf"];
const _c16 = [1, "mat-expansion-indicator", 3];
function MatExpansionPanelHeader_span_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", _c16);
} if (rf & 2) {
    const ctx_r176 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("@indicatorRotate", ctx_r176._getExpandedState());
} }
const _c17 = [[["mat-panel-title"]], [["mat-panel-description"]], "*"];
const _c18 = ["mat-panel-title", "mat-panel-description", "*"];
const _c19 = [1, "mat-expansion-panel-header-description"];
const _c20 = [1, "mat-expansion-panel-header-title"];
const _c21 = [1, "mat-accordion"];
...
MatExpansionPanelContent.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelContent, selectors: [["ng-template", "matExpansionPanelContent", ""]], factory: function MatExpansionPanelContent_Factory(t) { return new (t || MatExpansionPanelContent)(ɵngcc0.ɵɵdirectiveInject(TemplateRef)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatExpansionPanelContent, [{
        type: Directive,
        args: [{
                selector: 'ng-template[matExpansionPanelContent]'
            }]
    }], function () { return [{ type: TemplateRef }]; }, { constructor: [], _template: [] });
/** @nocollapse */
...
MatExpansionPanel.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatExpansionPanel, selectors: [["mat-expansion-panel"]], factory: function MatExpansionPanel_Factory(t) { return new (t || MatExpansionPanel)(ɵngcc0.ɵɵdirectiveInject(MAT_ACCORDION, 12), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(UniqueSelectionDispatcher), ɵngcc0.ɵɵdirectiveInject(ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(DOCUMENT), ɵngcc0.ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8), ɵngcc0.ɵɵdirectiveInject(MAT_EXPANSION_PANEL_DEFAULT_OPTIONS, 8)); }, contentQueries: function MatExpansionPanel_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, MatExpansionPanelContent, true, null);
    } if (rf & 2) {
        var _t;
        ...
        ɵngcc0.ɵɵclassProp(0, ctx.expanded);
        ɵngcc0.ɵɵclassProp(1, ctx._animationMode === "NoopAnimations");
        ɵngcc0.ɵɵclassProp(2, ctx._hasSpacing());
        ...
        ]), ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c8, consts: 7, vars: 4, template: function MatExpansionPanel_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef(_c7);
        ɵngcc0.ɵɵprojection(0);
        ɵngcc0.ɵɵelementStart(1, "div", _c3, _c4);
        ...
        ɵngcc0.ɵɵtemplate(5, MatExpansionPanel_ng_template_5_Template, 0, 0, "ng-template", _c6);
        ɵngcc0.ɵɵelementEnd();
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatExpansionPanel, [{
        ...
        args: [{ styles: [".mat-expansion-panel{box-sizing:content-box;display:block;margin:0;border-radius:4px;overflow:hidden;transition:margin 225ms cubic-bezier(.4,0,.2,1),box-shadow 280ms cubic-bezier(.4,0,.2,1)}.mat-accordion .mat-expansion-panel:not(.mat-expanded),.mat-accordion .mat-expansion-panel:not(.mat-expansion-panel-spacing){border-radius:0}.mat-accordion .mat-expansion-panel:first-of-type{border-top-right-radius:4px;border-top-left-radius:4px}.mat-accordion .mat-expansion-panel:last-of-type{border-bottom-right-radius:4px;border-bottom-left-radius:4px}@media (-ms-high-contrast:active){.mat-expansion-panel{outline:solid 1px}}.mat-expansion-panel._mat-animation-noopable,.mat-expansion-panel.ng-animate-disabled,.ng-animate-disabled .mat-expansion-panel{transition:none}.mat-expansion-panel-content{display:flex;flex-direction:column;overflow:visible}.mat-expansion-panel-body{padding:0 24px 16px}.mat-expansion-panel-spacing{margin:16px 0}.mat-accordion>.mat-expansion-panel-spacing:first-child,.mat-accordion>:first-child:not(.mat-expansion-panel) .mat-expansion-panel-spacing{margin-top:0}.mat-accordion>.mat-expansion-panel-spacing:last-child,.mat-accordion>:last-child:not(.mat-expansion-panel) .mat-expansion-panel-spacing{margin-bottom:0}.mat-action-row{border-top-style:solid;border-top-width:1px;display:flex;flex-direction:row;justify-content:flex-end;padding:16px 8px 16px 24px}.mat-action-row button.mat-button-base{margin-left:8px}[dir=rtl] .mat-action-row button.mat-button-base{margin-left:0;margin-right:8px}"],
                ...
                type: Inject,
                args: [MAT_ACCORDION]
            }] }, { type: ChangeDetectorRef }, { type: UniqueSelectionDispatcher }, { type: ViewContainerRef }, { type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
                ...
                type: Optional
            }] }]; }, { constructor: [], _viewContainerRef: [], _animationMode: [], _hideToggle: [], afterExpand: [{
            type: Output
        }], afterCollapse: [{
            type: Output
        }], _inputChanges: [], _headerId: [], _bodyAnimationDone: [], accordion: [], _document: [], hideToggle: [{
            type: Input
        }], hideToggle: [], togglePosition: [{
            type: Input
        }], togglePosition: [], _togglePosition: [], _hasSpacing: [], _getExpandedState: [], ngAfterContentInit: [], _portal: [], ngOnChanges: [], ngOnDestroy: [], _containsFocus: [], _lazyContent: [{
            type: ContentChild,
...
MatExpansionPanelHeader.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatExpansionPanelHeader, selectors: [["mat-expansion-panel-header"]], factory: function MatExpansionPanelHeader_Factory(t) { return new (t || MatExpansionPanelHeader)(ɵngcc0.ɵɵdirectiveInject(MatExpansionPanel, 1), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(FocusMonitor), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(MAT_EXPANSION_PANEL_DEFAULT_OPTIONS, 8)); }, hostBindings: function MatExpansionPanelHeader_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵattribute("id", ctx.panel._headerId);
        ɵngcc0.ɵɵattribute("tabindex", ctx.disabled ? 0 - 1 : 0);
        ɵngcc0.ɵɵattribute("aria-controls", ctx._getPanelId());
        ɵngcc0.ɵɵattribute("aria-expanded", ctx._isExpanded());
        ɵngcc0.ɵɵattribute("aria-disabled", ctx.panel.disabled);
        ɵngcc0.ɵɵupdateSyntheticHostBinding("@.disabled", ctx._animationsDisabled, null, true);
        ɵngcc0.ɵɵupdateSyntheticHostBinding("@expansionHeight", ɵngcc0.ɵɵpureFunction2(10, _c11, ctx._getExpandedState(), ɵngcc0.ɵɵpureFunction2(7, _c10, ctx.collapsedHeight, ctx.expandedHeight)), null, true);
        ɵngcc0.ɵɵclassProp(0, ctx._isExpanded());
        ɵngcc0.ɵɵclassProp(1, ctx._getTogglePosition() === "after");
        ɵngcc0.ɵɵclassProp(2, ctx._getTogglePosition() === "before");
        ɵngcc0.ɵɵstylingApply();
    } }, inputs: { expandedHeight: "expandedHeight", collapsedHeight: "collapsedHeight" }, ngContentSelectors: _c18, consts: 5, vars: 1, template: function MatExpansionPanelHeader_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtemplate(4, MatExpansionPanelHeader_span_4_Template, 1, 1, "span", _c15);
    } if (rf & 2) {
        ɵngcc0.ɵɵselect(4);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatExpansionPanelHeader, [{
        ...
        params: {
          ...
          expandedHeight: expandedHeight
                ...
                type: Host
            }] }, { type: ElementRef }, { type: FocusMonitor }, { type: ChangeDetectorRef }, { type: undefined, decorators: [{
                type: Inject,
                args: [MAT_EXPANSION_PANEL_DEFAULT_OPTIONS]
            }, {
                type: Optional
            }] }]; }, { constructor: [], panel: [], _element: [], _focusMonitor: [], _changeDetectorRef: [], _parentChangeSubscription: [], _animationsDisabled: [], expandedHeight: [{
            type: Input
        }], collapsedHeight: [{
            type: Input
...
MatAccordion.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: MatAccordion, selectors: [["mat-accordion"]], factory: function MatAccordion_Factory(t) { return ɵMatAccordion_BaseFactory(t || MatAccordion); }, contentQueries: function MatAccordion_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, MatExpansionPanelHeader, true, null);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatAccordion, [{
    ...
    }], null, { constructor: [], _hideToggle: [], displayMode: [{
            type: Input
        }], togglePosition: [{
            type: Input
        }], hideToggle: [{
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatExpansionModule, { declarations: function () { return [MatAccordion,
        MatExpansionPanel,
...
MatExpansionModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function MatExpansionModule_Factory(t) { return new (t || MatExpansionModule)(); }, imports: [[CommonModule, CdkAccordionModule, PortalModule]] });
