...
MatBottomSheetContainer.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MatBottomSheetContainer, selectors: [["mat-bottom-sheet-container"]], factory: function MatBottomSheetContainer_Factory(t) { return new (t || MatBottomSheetContainer)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(FocusTrapFactory), ɵngcc0.ɵɵdirectiveInject(BreakpointObserver), ɵngcc0.ɵɵdirectiveInject(DOCUMENT, 8), ɵngcc0.ɵɵdirectiveInject(MatBottomSheetConfig)); }, viewQuery: function MatBottomSheetContainer_Query(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatBottomSheetContainer, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: ChangeDetectorRef }, { type: FocusTrapFactory }, { type: BreakpointObserver }, { type: undefined, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: MatBottomSheetConfig }]; }, { constructor: [], _elementRef: [], _changeDetectorRef: [], _focusTrapFactory: [], bottomSheetConfig: [], _animationState: [], _animationStateChanged: [], _elementFocusedBeforeOpened: [], _document: [], _breakpointSubscription: [], attachComponentPortal: [], attachTemplatePortal: [], enter: [], exit: [], ngOnDestroy: [], _destroyed: [], _onAnimationDone: [], _onAnimationStart: [], _toggleClass: [], _validatePortalAttached: [], _setPanelClass: [], _trapFocus: [], _focusTrap: [], _restoreFocus: [], _savePreviouslyFocusedElement: [], _portalOutlet: [{
            type: ViewChild,
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(MatBottomSheetModule, { declarations: function () { return [MatBottomSheetContainer]; }, imports: function () { return [CommonModule,
        OverlayModule,
        MatCommonModule,
...
MatBottomSheet.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: MatBottomSheet, factory: function MatBottomSheet_Factory(t) { return new (t || MatBottomSheet)(ɵngcc0.ɵɵinject(Overlay), ɵngcc0.ɵɵinject(Injector), ɵngcc0.ɵɵinject(MatBottomSheet, 12), ɵngcc0.ɵɵinject(Location, 8), ɵngcc0.ɵɵinject(MAT_BOTTOM_SHEET_DEFAULT_OPTIONS, 8)); }, providedIn: MatBottomSheetModule });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatBottomSheet, [{
        type: Injectable,
        args: [{ providedIn: MatBottomSheetModule }]
    }], function () { return [{ type: Overlay }, { type: Injector }, { type: MatBottomSheet, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            ...
            }] }]; }, { constructor: [], _overlay: [], _injector: [], _parentBottomSheet: [], _location: [], _defaultOptions: [], _bottomSheetRefAtThisLevel: [], _openedBottomSheetRef: [], _openedBottomSheetRef: [], open: [], dismiss: [], ngOnDestroy: [], _attachContainer: [], _createOverlay: [], _createInjector: [] });
/** @nocollapse */
