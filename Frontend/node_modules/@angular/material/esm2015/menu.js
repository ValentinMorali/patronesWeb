...
function _MatMenu_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function _MatMenu_ng_template_0_Template_div_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r188); const ctx_r187 = ɵngcc0.ɵɵnextContext(); return ctx_r187._handleKeydown($event); });
    ɵngcc0.ɵɵlistener("click", function _MatMenu_ng_template_0_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r188); const ctx_r189 = ɵngcc0.ɵɵnextContext(); return ctx_r189.closed.emit("click"); });
    ɵngcc0.ɵɵlistener("@transformMenu.start", function _MatMenu_ng_template_0_Template_div_animation_transformMenu_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r188); const ctx_r190 = ɵngcc0.ɵɵnextContext(); return ctx_r190._onAnimationStart($event); });
    ɵngcc0.ɵɵlistener("@transformMenu.done", function _MatMenu_ng_template_0_Template_div_animation_transformMenu_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r188); const ctx_r191 = ɵngcc0.ɵɵnextContext(); return ctx_r191._onAnimationDone($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r186._classList)("@transformMenu", ctx_r186._panelAnimationState);
} }
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatMenuContent, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: ChangeDetectorRef }]; }, { constructor: [], _template: [], _componentFactoryResolver: [], _appRef: [], _injector: [], _viewContainerRef: [], _document: [], _changeDetectorRef: [], _attached: [], attach: [], _portal: [], _outlet: [], detach: [], ngOnDestroy: [] });
/** @nocollapse */
