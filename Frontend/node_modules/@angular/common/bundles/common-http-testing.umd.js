...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('@angular/core'), require('rxjs'),require('@angular/core'),require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@angular/common/http/testing', ['exports', '@angular/common/http', '@angular/core', 'rxjs','@angular/core','@angular/common/http'], factory) :
...
}(this, function (exports, http, core, rxjs,ɵngcc0,ɵngcc1) { 'use strict';
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(HttpClientTestingModule, { imports: [ɵngcc1.HttpClientModule] });
