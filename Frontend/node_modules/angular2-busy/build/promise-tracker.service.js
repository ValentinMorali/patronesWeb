...
PromiseTrackerService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: PromiseTrackerService, factory: function PromiseTrackerService_Factory(t) { return new (t || PromiseTrackerService)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PromiseTrackerService, [{
        type: core_1.Injectable
    }], function () { return []; }, { promiseList: [], delayJustFinished: [], reset: [], minDuration: [], delayPromise: [], durationPromise: [], addPromise: [], finishPromise: [], isActive: [] });
