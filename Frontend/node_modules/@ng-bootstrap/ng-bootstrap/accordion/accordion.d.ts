...
export declare class NgbPanelHeader {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbPanelHeader, "ng-template[ngbPanelHeader]", never, {}, {}, never>;
}
/**
...
export declare class NgbPanelTitle {
    templateRef: TemplateRef<any>;
    constructor(templateRef: TemplateRef<any>);
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbPanelTitle, "ng-template[ngbPanelTitle]", never, {}, {}, never>;
}
/**
...
export declare class NgbPanelContent {
    templateRef: TemplateRef<any>;
    constructor(templateRef: TemplateRef<any>);
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbPanelContent, "ng-template[ngbPanelContent]", never, {}, {}, never>;
}
/**
...
export declare class NgbPanel implements AfterContentChecked {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbPanel, "ngb-panel", never, { 'disabled': "disabled", 'id': "id", 'title': "title", 'type': "type" }, {}, ["titleTpls", "headerTpls", "contentTpls"]>;
}
/**
...
export declare class NgbAccordion implements AfterContentChecked {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<NgbAccordion, "ngb-accordion", ["ngbAccordion"], { 'activeIds': "activeIds", 'destroyOnHide': "destroyOnHide", 'type': "type", 'closeOtherPanels': "closeOthers" }, { 'panelChange': "panelChange" }, ["panels"]>;
}
/**
...
export declare class NgbPanelToggle {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbPanelToggle, "button[ngbPanelToggle]", never, { 'ngbPanelToggle': "ngbPanelToggle" }, {}, never>;
}
