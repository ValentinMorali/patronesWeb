...
export declare class NgbTooltipWindow {
    id: string;
    tooltipClass: string;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<NgbTooltipWindow, "ngb-tooltip-window", never, { 'id': "id", 'tooltipClass': "tooltipClass" }, {}, never>;
}
/**
