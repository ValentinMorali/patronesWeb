...
export declare class NgbTabTitle {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbTabTitle, "ng-template[ngbTabTitle]", never, {}, {}, never>;
}
/**
...
export declare class NgbTabContent {
    templateRef: TemplateRef<any>;
    constructor(templateRef: TemplateRef<any>);
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbTabContent, "ng-template[ngbTabContent]", never, {}, {}, never>;
}
/**
...
export declare class NgbTab implements AfterContentChecked {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbTab, "ngb-tab", never, { 'id': "id", 'disabled': "disabled", 'title': "title" }, {}, ["titleTpls", "contentTpls"]>;
}
/**
...
export declare class NgbTabset implements AfterContentChecked {
    ...
    ngAfterContentChecked(): void;
    private _getTabById;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<NgbTabset, "ngb-tabset", ["ngbTabset"], { 'destroyOnHide': "destroyOnHide", 'type': "type", 'justify': "justify", 'orientation': "orientation", 'activeId': "activeId" }, { 'tabChange': "tabChange" }, ["tabs"]>;
}
