...
export declare class NgbTypeahead implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbTypeahead, "input[ngbTypeahead]", ["ngbTypeahead"], { 'autocomplete': "autocomplete", 'placement': "placement", 'container': "container", 'editable': "editable", 'focusFirst': "focusFirst", 'showHint': "showHint", 'inputFormatter': "inputFormatter", 'ngbTypeahead': "ngbTypeahead", 'resultFormatter': "resultFormatter", 'resultTemplate': "resultTemplate" }, { 'selectItem': "selectItem" }, never>;
}
