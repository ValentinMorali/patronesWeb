...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgbTypeahead, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: NgZone }, { type: ChangeDetectorRef }, { type: ApplicationRef }]; }, { _elementRef: [], _viewContainerRef: [], _renderer: [], _injector: [], _live: [], _document: [], _ngZone: [], _changeDetector: [], _applicationRef: [], _closed$: [], autocomplete: [{
            type: Input
        }], placement: [{
            type: Input
        }], selectItem: [{
