...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgbModal, [{
    ...
    }], function () { return [{ type: ComponentFactoryResolver }, { type: Injector }, { type: NgbModalStack }, { type: NgbModalConfig }]; }, { _moduleCFR: [], _injector: [], _modalStack: [], _config: [], open: [], dismissAll: [], hasOpenModals: [] });
    return NgbModal;
}());
export { NgbModal };
if (false) {
