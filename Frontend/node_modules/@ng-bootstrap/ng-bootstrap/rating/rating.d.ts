...
export declare class NgbRating implements ControlValueAccessor, OnInit, OnChanges {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<NgbRating, "ngb-rating", never, { 'max': "max", 'readonly': "readonly", 'rate': "rate", 'resettable': "resettable", 'starTemplate': "starTemplate" }, { 'hover': "hover", 'leave': "leave", 'rateChange': "rateChange" }, ["starTemplateFromContent"]>;
}
